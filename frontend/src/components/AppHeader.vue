...
import { LogOutOutline, SettingsOutline, HandRightOutline, HelpCircleOutline } from '@vicons/ionicons5'
...
<template>
  <header class="app-header">
    ...
    <div class="header-right">
      <a href="/pipeline-data-flow.html" target="_blank" rel="noopener" style="text-decoration: none;">
