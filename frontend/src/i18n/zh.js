export default {
  ...
  phase3Test: {
    ...
    generated: '生成视频',
    comparison: '对比',
    noJobs: '暂无测试任务，请选择视频开始。',
    filterAll: '全部',
    filterRunning: '运行中',
    filterCompleted: '已完成',
    filterFailed: '失败',
    statusPending: '等待中...',
    statusTransfer: 'MimicMotion 迁移中...',
    statusProcessing: '视频处理中...',
    statusFramer: 'FramerTurbo 插值中...',
    totalTime: '总耗时',
    transferTime: '人物迁移',
    processTime: '视频处理',
    framerTime: '帧插值',
  ...
  signVideo: {
    ...
    textLabel: '英文文本',
    textPlaceholder: '输入要转换为手语视频的英文文本',
    submit: '开始生成',
    cancel: '取消',
    glossCount: '提取 Gloss',
    matchedCount: '匹配视频',
    ...
    download: '下载',
    delete: '删除',
    confirmDelete: '确定要删除此生成任务吗？',
    statusPending: '等待中...',
    statusExtracting: '正在提取 Gloss...',
    statusMatching: '正在匹配视频...',
    statusConcatenating: '正在拼接视频...',
    unmatchedWarning: '{count} 个 Gloss 未找到匹配视频',
