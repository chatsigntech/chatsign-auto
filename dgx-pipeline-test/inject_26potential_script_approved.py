...
Inputs:
    /home/chatsign/lizh/chatsign-auto/dgx-pipeline-test/26_potential_script_approved_manifest.jsonl
    /mnt/data/chatsign-phase3-test/26_potential_script-render-20260507/videos/<hex>_hiya.mp4 (one per row)

Outputs (all under chatsign-accuracy/):
    backend/data/texts/26_potential_script-render-20260507.jsonl     (873 words, sid 1..873)
    backend/data/review/generated/26_potential_script-render-20260507/<hex>_hiya.mp4
...
MANIFEST = REPO / "dgx-pipeline-test" / "26_potential_script_approved_manifest.jsonl"
STAGE_VIDS = Path("/mnt/data/chatsign-phase3-test/26_potential_script-render-20260507/videos")

BATCH_NAME = "26_potential_script-render-20260507.jsonl"
OUT_VIDEO_DIR = ACC / "review" / "generated" / "26_potential_script-render-20260507"
...
def main():
    ...
    for r in records:
        r["_video_id"] = f"c26ps_a_{r['new_sid']:04d}"
    ...
    for r in new_records:
        ...
        new_entries.append({
            ...
            "language": "en",
            "videoPath": f"review/generated/26_potential_script-render-20260507/{r['_fname']}",
            "videoFileName": r["_fname"],
            "localPath": f"26_potential_script-render-20260507/{r['_fname']}",
            "source": "generated",
