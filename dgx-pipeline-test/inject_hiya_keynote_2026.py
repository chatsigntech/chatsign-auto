#!/usr/bin/env python3
"""Inject 63 hiya_keynote_2026 DGX-rendered sentences into chatsign-accuracy.

Inputs:
    /home/chatsign/lizh/chatsign-auto/dgx-pipeline-test/hiya_keynote_2026_manifest.jsonl
    /mnt/data/chatsign-phase3-test/hiya_keynote_2026-render-20260507/videos/<hex>_hiya.mp4 (one per row)

Outputs (all under chatsign-accuracy/):
    backend/data/texts/hiya_keynote_2026-render-20260507.jsonl     (63 sentences, sid 1..63)
    backend/data/review/generated/hiya_keynote_2026-render-20260507/<hex>_hiya.mp4
    backend/data/reports/pending-videos.jsonl   (63 new entries appended, source=generated)
...
STAGE_VIDS = Path("/mnt/data/chatsign-phase3-test/hiya_keynote_2026-render-20260507/videos")

BATCH_NAME = "hiya_keynote_2026-render-20260507.jsonl"
OUT_VIDEO_DIR = ACC / "review" / "generated" / "hiya_keynote_2026-render-20260507"
...
def main():
    ...
    for r in records:
        r["_video_id"] = f"c_hiya26_{r['new_sid']:04d}"
    ...
    for r in new_records:
        ...
        new_entries.append({
            ...
            "language": "en",
            "videoPath": f"review/generated/hiya_keynote_2026-render-20260507/{r['_fname']}",
            "videoFileName": r["_fname"],
            "localPath": f"hiya_keynote_2026-render-20260507/{r['_fname']}",
            "source": "generated",
