...
STATE = REPO / "dgx-pipeline-test" / "chatsign_opening_introduction_approved_state.json"
STAGING = Path("/mnt/data/chatsign-phase3-test/chatsign-opening-introduction-render-20260508/videos")
